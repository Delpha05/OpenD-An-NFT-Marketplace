...
```
dfx canister call opend listItem '(principal "<YOUR VALUE HERE>", 2)'
```
...
```
dfx canister call <YOUR VALUE HERE> transferOwnership '(principal "<YOUR CANISTER ID>", true)'
```
